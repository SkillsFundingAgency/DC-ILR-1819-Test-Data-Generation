        ...
        : ILearnerMultiMutator
    {
        ...
        public IEnumerable<LearnerTypeMutator> LearnerMutators(ILearnerCreatorDataCache cache)
        {
            ...
            return new List<LearnerTypeMutator>()
            {
                ...
                new LearnerTypeMutator() { LearnerType = LearnerTypeRequired.YP1619, DoMutateLearner = MutateLearner, DoMutateOptions = MutateGenerationOptions, DoMutateProgression = MutateProgressionOOutStartDate, ExclusionRecord = true },
                new LearnerTypeMutator() { LearnerType = LearnerTypeRequired.Adult, DoMutateLearner = MutateLearner, DoMutateOptions = MutateGenerationOptions, DoMutateProgression = MutateProgressionOOutStartDate, ExclusionRecord = true },
            };
        }
        ...
        private void MutateProgressionFM25(MessageLearnerDestinationandProgression learner, bool valid)
        {
            ...
            if (!valid)
            {
                var startDate = new DateTime(2019, 08, 31);
        ...
        private void MutateProgression(MessageLearnerDestinationandProgression learner, bool valid)
        {
            ...
            if (!valid)
            {
                ...
                dp.OutStartDate = startDate.AddYears(1).AddDays(1);
            }
        }

        private void MutateProgressionOOutStartDate(MessageLearnerDestinationandProgression learner, bool valid)
        {
            var dp = learner.DPOutcome[0];
            if (!valid)
            {
