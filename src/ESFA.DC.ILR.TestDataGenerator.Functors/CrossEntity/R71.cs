        ...
        : ILearnerMultiMutator
    {
        ...
        public IEnumerable<LearnerTypeMutator> LearnerMutators(ILearnerCreatorDataCache cache)
        {
            return new List<LearnerTypeMutator>()
            {
                ...
                new LearnerTypeMutator() { LearnerType = LearnerTypeRequired.YP1619, DoMutateLearner = MutateLearner, DoMutateOptions = MutateGenerationOption, ExclusionRecord = true }
            };
        }
        ...
        private void MutateDPOutcome(MessageLearner learner, bool valid)
        {
            ...
            if (!valid)
            {
                _options.CreateMultipleDestinationAndProgression = 2;
            }
        }
        ...
        private void MutateGenerationOption(GenerationOptions options)
        {
            _options = options;
            options.EmploymentRequired = true;
            options.CreateDestinationAndProgression = true;
