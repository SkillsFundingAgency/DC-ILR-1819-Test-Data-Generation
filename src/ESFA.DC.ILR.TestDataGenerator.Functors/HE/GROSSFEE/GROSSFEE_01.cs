        ...
        : ILearnerMultiMutator
    {
        ...
        public IEnumerable<LearnerTypeMutator> LearnerMutators(ILearnerCreatorDataCache cache)
        {
            return new List<LearnerTypeMutator>()
            {
                ...
                new LearnerTypeMutator() { LearnerType = LearnerTypeRequired.NonFunded, DoMutateLearner = MutateGrossFee, DoMutateOptions = MutateGenerationOptions, ExclusionRecord = true }
            };
        }
        ...
        public void MutateGrossFee(MessageLearner learner, bool valid)
        {
            var ldhe = new List<MessageLearnerLearningDeliveryLearningDeliveryHE>();
            if (valid)
            {
