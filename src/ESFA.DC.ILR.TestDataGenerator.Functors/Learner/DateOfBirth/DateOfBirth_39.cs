...
//            learner.LearningDelivery[0].LearnStartDate = DateTime.Parse("2014-AUG-01");
        ...
        private void MutateCommon(MessageLearner learner, bool valid)
        {
            ...
            Helpers.SetLearningDeliveryEndDates(learner.LearningDelivery[0], learner.LearningDelivery[0].LearnStartDate.AddYears(1), Helpers.SetAchDate.SetAchDate);
            learner.LearningDelivery[0].AchDateSpecified = false;
            Helpers.SetLearningDeliveryEndDates(learner.LearningDelivery[1], learner.LearningDelivery[0].LearnStartDate.AddYears(1), Helpers.SetAchDate.SetAchDate);
            learner.LearningDelivery[1].AchDateSpecified = false;

            if (!valid)
            {
                Helpers.SetLearningDeliveryEndDates(learner.LearningDelivery[0], learner.LearningDelivery[0].LearnStartDate.AddDays(180), Helpers.SetAchDate.SetAchDate);
            }
        }
