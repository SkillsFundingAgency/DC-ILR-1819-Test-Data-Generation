...
namespace DCT.TestDataGenerator.Functor
{
        ...
        : ILearnerMultiMutator
    {
        ...
        //private void Mutate16HigherLevelApprenticeship7(MessageLearner learner, bool valid)
        //{
        //    Mutate16(learner, valid);
        //    foreach (var ld in learner.LearningDelivery)
        //    {
        ...
        //    }
        //}
        //private void Mutate16ApprenticeshipStandard(MessageLearner learner, bool valid)
        //{
        //    Mutate16(learner, valid);
        //    foreach (var ld in learner.LearningDelivery)
        //    {
        ...
        {
            learner.LearningDelivery[0].LearnStartDate = DateTime.Parse("2014-JUN-01");
            MutateCommon(learner, valid);
        }
