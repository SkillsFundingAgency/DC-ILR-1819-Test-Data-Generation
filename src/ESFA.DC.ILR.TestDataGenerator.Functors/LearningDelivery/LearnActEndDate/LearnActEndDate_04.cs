...
{
    public class LearnActEndDate_04
        : ILearnerMultiMutator
    {
        ...
        public IEnumerable<LearnerTypeMutator> LearnerMutators(ILearnerCreatorDataCache cache)
        {
            ...
            {
                new LearnerTypeMutator() { LearnerType = LearnerTypeRequired.NonFunded, DoMutateLearner = MutateLD2Restart, DoMutateOptions = MutateGenerationOptionsLD2, DoMutateProgression = Mutate19LD2RestartsDestAndProg }
            };
        }

        public string RuleName()
        {
            return "LearnActEndDate_04";
        }
        ...
        private void MutateLD2Restart(MessageLearner learner, bool valid)
        {
            ...
            if (!valid)
            {
                Helpers.SetLearningDeliveryEndDates(lds[1], DateTime.Today.AddDays(+1), Helpers.SetAchDate.DoNotSetAchDate);
            }
