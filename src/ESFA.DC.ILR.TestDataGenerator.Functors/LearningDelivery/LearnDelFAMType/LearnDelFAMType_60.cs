...
{
    public class LearnDelFAMType_60
        : ILearnerMultiMutator
    {
        ...
        public IEnumerable<LearnerTypeMutator> LearnerMutators(ILearnerCreatorDataCache cache)
        {
            ...
            return new List<LearnerTypeMutator>()
            {
                ...
                new LearnerTypeMutator() { LearnerType = LearnerTypeRequired.Adult, DoMutateLearner = MutatePriorAttain, DoMutateOptions = MutateUSDCOptions, ExclusionRecord = true },
        ...
        private void MutateLearner(MessageLearner learner, bool valid)
        {
            ...
            if (!valid)
            {
                learner.DateOfBirth = learner.LearningDelivery[0].LearnStartDate.AddYears(-25).AddMonths(+3);
        ...
        private void MutateESOL(MessageLearner learner, bool valid)
        {
            ...
            if (!valid)
            {
                learner.LearningDelivery[0].LearnAimRef = "60152229";
            }
        }
        ...
        private void MutateUSDCOptions(GenerationOptions options)
        {
