        ...
        : ILearnerMultiMutator
    {
        ...
        public IEnumerable<LearnerTypeMutator> LearnerMutators(ILearnerCreatorDataCache cache)
        {
            ...
            return new List<LearnerTypeMutator>()
            {
                ...
                new LearnerTypeMutator() { LearnerType = LearnerTypeRequired.Apprenticeships, DoMutateLearner = MutateAfinDate, DoMutateOptions = MutateGenerationOptions, ExclusionRecord = true },
                new LearnerTypeMutator() { LearnerType = LearnerTypeRequired.Apprenticeships, DoMutateLearner = MutateAfinDate1, DoMutateOptions = MutateGenerationOptions, ExclusionRecord = true }
            };
        }
        ...
        private void MutateLearner(MessageLearner learner, bool valid)
        {
            ...
            if (!valid)
            {
                    ...
                    appfin.Add(new MessageLearnerLearningDeliveryAppFinRecord()
                    {
                        ...
                        AFinCodeSpecified = true,
                        AFinDate = DateTime.Now.AddDays(+1),
                        AFinDateSpecified = true
                    });
